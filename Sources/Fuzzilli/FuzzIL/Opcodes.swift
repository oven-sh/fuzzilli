...
enum Opcode {
    ...
    case endClassInstanceComputedMethod(EndClassInstanceComputedMethod)
    ...
    case endClassStaticComputedMethod(EndClassStaticComputedMethod)
    ...
    case wasmDefineDataSegment(WasmDefineDataSegment)
    ...
    case wasmTableSize(WasmTableSize)
    case wasmTableGrow(WasmTableGrow)
    ...
    case wasmAtomicCmpxchg(WasmAtomicCmpxchg)
    case wasmMemorySize(WasmMemorySize)
    case wasmMemoryGrow(WasmMemoryGrow)
    case wasmMemoryFill(WasmMemoryFill)
    case wasmMemoryInit(WasmMemoryInit)
    case wasmDropDataSegment(WasmDropDataSegment)
    ...
    case wasmBeginTryTable(WasmBeginTryTable)
    case wasmEndTryTable(WasmEndTryTable)
    ...
    case wasmArraySet(WasmArraySet)
    case wasmStructNewDefault(WasmStructNewDefault)
