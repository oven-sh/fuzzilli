...
public let CallExpression = ExpressionType(
    precedence: 19, associativity: .left, characteristic: .effectful)
public let MemberExpression = ExpressionType(
    precedence: 19, associativity: .left, characteristic: .effectful)
...
public let UnaryExpression = ExpressionType(
    precedence: 15, associativity: .right, characteristic: .effectful)
public let BinaryExpression = ExpressionType(
    precedence: 14, associativity: .none, characteristic: .effectful)
public let TernaryExpression = ExpressionType(
    precedence: 4, associativity: .none, characteristic: .effectful)
public let AssignmentExpression = ExpressionType(
    precedence: 3, associativity: .right, characteristic: .effectful)
public let ArrowFunctionExpression = ExpressionType(
    precedence: 3, associativity: .right, characteristic: .effectful)
public let YieldExpression = ExpressionType(
    precedence: 2, associativity: .right, characteristic: .effectful)
public let SpreadExpression = ExpressionType(precedence: 2, characteristic: .effectful)
public let CommaExpression = ExpressionType(
    precedence: 1, associativity: .left, characteristic: .effectful)
